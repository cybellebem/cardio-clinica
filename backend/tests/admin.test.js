...
describe("Listagens",()=>{
    const casos=[
        ...
        ["lista atendentes",rotas.pessoas.lista("Atendente"),200],
        ["lista admins",rotas.pessoas.lista("Admin"),200],
        ["lista paciente específico",rotas.pessoas.porId(id.paciente),200],
        ["lista médico específico",rotas.pessoas.porId(id.medico),200],
        ["lista admin específico",rotas.pessoas.porId(id.admin),200],
        ["lista atendente específico",rotas.pessoas.porId(id.atendente),200],
...
describe("Ativar e desativar",()=>{
    const casos=[
        ...
        ["ativa admin específico",rotas.pessoas.ativar(id.admin),200],
        ["ativa atendente específico",rotas.pessoas.ativar(id.atendente),200],
        ...
        ["desativa admin específico",rotas.pessoas.desativar(id.admin),200],
        ["desativa atendente específico",rotas.pessoas.desativar(id.atendente),200]
    ]
...
describe("Inclusões",()=>{
    const casos=[
        ["cadastra admin",rotas.pessoas.incluir,{
            "cpf":"46809872000",
            "nome":"João da Silva",
            "data_nascimento":"1980-01-01",
            "telefone":"51990000001",
        ...
        ["cadastra atendente",rotas.pessoas.incluir,{
            "cpf": "40744490057",
