...
describe("Listagens",()=>{
    const casos=[
        ["lista médicos e pacientes","/pessoas/lista",200],
...
describe("Ativar e desativar",()=>{
    const casos=[
        ["ativa médico específico",`/pessoas/ativar/${id.medico}`,200],
        ["desativa médico específico",`/pessoas/desativar/${id.medico}`,200],
        ["ativa paciente específico",`/pessoas/ativar/${id.paciente}`,200],
        ["desativa paciente específico",`/pessoas/desativar/${id.paciente}`,200],
...
describe("Inclusões",()=>{
    const casos=[
        ...
        ["cadastra médico","/pessoas/incluir",{
            "cpf": "747.906.860-35",
